                ...
                <table class="c-table">
                  <thead class="c-table__head">
                    <tr class="c-table__row">
                      ...
                      <th class="c-table__cell c-table__cell--head">Skill Tags</th>
                  ...
                  <tbody>
                    ...
                    function getIfSet(& $var) {
                      ...
                      foreach ($response as $key => $value) {
                        ...
                        $disease_tags = str_replace("Cancer", "Coder", $disease_tags);
                        $disease_tags = str_replace(" Cholera", "Designer", $disease_tags);
                        $disease_tags = str_replace("Urolithiasis", "Management", $disease_tags);
                        $disease_tags = str_replace("HIV", "Testing", $disease_tags);
                        $disease_tags = str_replace("Polio", "Business", $disease_tags);
                        $disease_tags = str_replace("Poik", "Developer", $disease_tags);
                        $disease_tags = str_replace("Cholera", "Developer", $disease_tags);
